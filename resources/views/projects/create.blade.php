    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-12">
                ...
                <form class="" method="post" action="{{ route('projects.store',$currentWorkspace->slug) }}" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="category" aria-label="Search your category">
                                <option value="1">Logo Design</option>
                                <option value="2">Social Media Design</option>
                                <option value="3">Poster Design</option>
                                <option value="4">Banner Design</option>
                                <option value="5">Landing Page Design</option>
                            </select>
                        </div>
                        <div class="form-group">
