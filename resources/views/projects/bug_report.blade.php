                                               ...
                                               <div class="user-group">
                                                     ...
                                                     @if($currentWorkspace->permission == 'Owner' || isset($permissions))
                                                                        ...
                                                                        <a href="#" class="img_group">
                                                                                       <img alt="image" data-toggle="tooltip" data-original-title="{{($bug->user)?$bug->user->name:''}}" @if(($bug->user)?$bug->user->avatar:'') src="{{$logo.$bug->user->avatar}}" @else avatar="{{($bug->user)?$bug->user->name:'' }}"@endif>
                                                                      </a>
                                                      @endif
                                             </div>
                                        </div>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.deleteUrl.length > 0) {
                            delLink = "<a href='#' class='delete-icon delete-comment-file action-btn btn-danger  btn btn-sm d-inline-flex align-items-center mx-1'  data-url='" + data.deleteUrl + "'>" +
                                "                                        <i class='ti ti-trash'></i>" +
                                "                                    </a>";
                        }
                        ...
                        var html = "<div class='card mb-1 shadow-none border'>" +
                            ...
                            "                                </div>" +
                            "                                <div class='col-auto'>" +
                            "                                    <a download href='{{$logo_tasks}}/" + data.file + "' class='action-btn btn-primary  btn btn-sm d-inline-flex align-items-center'>" +
