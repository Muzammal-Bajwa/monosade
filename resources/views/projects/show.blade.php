                                            ...
                                            <div class="col-sm-auto mb-3 mb-sm-0">
                                                <div class="d-flex align-items-center px-2">
                                                   <a href="#" class=" text-start">
                                                        <img  class="fix_img" @if($user->avatar) src="{{asset($logo.$user->avatar)}}" @else avatar="{{ $user->name }}" @endif>
                                                    </a>
                                                    <div class="px-2">
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row align-items-center justify-content-between">
                                            <div class="col-sm-auto mb-3 mb-sm-0">
                                                <div class="d-flex align-items-center px-2">
                                                   <a href="#" class=" text-start">
                                                        <img  class="fix_img" @if($client->avatar) src="{{asset($logo.$client->avatar)}}" @else avatar="{{ $client->name }}"@endif>
                                                    </a>
                                                    <div class="px-2">
                                        ...
                                        <div class="timeline-block px-2 pt-3">
                                            ...
                                            <div class="last_notification_text">
                                              <!--   <p class="m-0"> <span>{{ $activity->log_type }} </span> </p> <br> -->
                                                 <p class="m-0"> <span>{{ $activity->logType($activity->log_type) }} </span> </p> <br> 
...
<script>
    ...
    <script src="{{asset('assets/custom/js/dropzone.min.js')}}"></script>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.is_success) {
                                ...
                                show_toastr('{{__('Error')}}', 'Something Wents Wrong.', 'error');
                            }
                        },
        ...
        @if (file_exists($storage_file))
             ...
             var mockFile = {name: "{{$file->file_name}}", size: {{ filesize('storage/project_files/'.$file->file_path) }} };
