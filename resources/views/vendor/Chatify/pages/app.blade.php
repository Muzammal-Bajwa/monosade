                ...
                <nav class="d-flex a;align-items-center justify-content-between">
                    ...
                    <div style="display: flex;">
                            ...
                            @if(!empty(Auth::user()->avatar))
                                <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px;background-image: url('{{asset($avatar.Auth::user()->avatar)}}');"></div>

                            @else
                                <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px;background-image: url('{{asset($avatar.'avatar.png')}}');"></div>
                            @endif
