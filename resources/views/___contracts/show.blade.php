                    ...
                    <div class="dropdown-menu dash-h-dropdown">
                        @foreach ($editstatus as $k => $status)
                            <a class="dropdown-item status" data-id="{{ $k }}"
                                data-url="{{ route('contract.status',[$currentWorkspace->slug,$contract->id]) }}"
                                                        ...
                                                        <div class="list-group-item ">
                                                            <div class="row align-items-center">
                                                                <div class="col-auto">
                                                                  ...
                                                                  @if($comment->user->avatar) src="{{asset($logo.$comment->user->avatar)}}"
                                                                   @else 
                                                                  ...
                                                                  @if($comment->client->avatar) src="{{asset($logo.$comment->client->avatar)}}"
                                                                   @else 
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col-auto">
                                                                ...
                                                                <img class="avatar-sm rounded-circle img-thumbnail" width="" style="max-width: 30px; max-height: 30px;"
                                                                  ...
                                                                  @if($note->user->avatar) src="{{asset($logo.$note->user->avatar)}}"
                                                                   @else 
                                                               ...
                                                               @else 
                                                                   ...
                                                                   @if($note->client->avatar) src="{{asset($logo.$note->client->avatar)}}"
                                                                   @else 
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                var html = "<div class='list-group-item px-0'>" +
                                    ...
                                    "                                <img src="asset(+data.default_img+)" alt='' class='avatar-sm rounded-circle'>" +
                                    "                            </a>" +
                                    "                        </div>" +
                                    "                        <div class='col ml-n2'>" +
