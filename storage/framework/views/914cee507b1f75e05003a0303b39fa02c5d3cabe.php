                                                ...
                                                <div class="card ">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="logo-content">
                                                            <img id="dark_logo" alt="yourimage"
                                                        ...
                                                        <div class="choose-file mt-5 ">
                                                            <label for="logo_blue">
                                                                ...
                                                                <input type="file" class="form-control" name="logo_blue"
                                                ...
                                                <div class="card ">
                                                    ...
                                                    <div class="card-body" style="height: 220px !important">
                                                        <div class="logo-content">
                                                            ...
                                                            <img src="<?php echo e(asset($logo . 'favicon.png')); ?>" class="small_logo"
                                                                id="favicon" style="width: 90px !important;" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <?php if(env('gdpr_cookie') == 'on'): ?>
                                                        ...
                                                        <?php echo Form::textarea('cookie_text', env('cookie_text'), [
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            ...
                                                            <div class="theme-color themes-color">
                                                                <input type="hidden" name="theme_color" id=""
                                                                    ...
                                                                    <div class="accordion-body">
                                                                        <div class="text-end">
                                                                            <div
                                                                                ...
                                                                                <label
                                                                                    class="custom-control-label form-control-label"
                                                                                    for="is_mercado_enabled"><?php echo e(__('Enable CoinGate')); ?></label>
                                                                            </div>
                                                                        </div>
                                                                        <div
                                                                            class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pb-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                ...
                                                <input class="form-control " placeholder="Enter Pusher App Secret"
                                                    ...
                                                    value="<?php echo e(env('PUSHER_APP_SECRET')); ?>" id="pusher_app_secret" required>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                ...
                                                <input class="form-control " placeholder="Enter Pusher App Cluster"
                                                    ...
                                                    value="<?php echo e(env('PUSHER_APP_CLUSTER')); ?>" id="pusher_app_cluster" required >
                                            </div>
                                        </div>
                                        <div class="text-end">
                                            <input type="submit" value="<?php echo e(__('Save Changes')); ?>"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="<?php echo e(env('NOCAPTCHA_SITEKEY')); ?>" id="google_recaptcha_key" required > 
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\saas\resources\views/setting.blade.php ENDPATH**/ ?>