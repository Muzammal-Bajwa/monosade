...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" dir="<?php echo e(env('SITE_RTL') == 'on'?'rtl':''); ?>">
 ...
 <!--    <link rel="stylesheet" href="<?php echo e(asset('assets/css/style.css')); ?>" id="main-style-link"> -->
    ...
    <nav class="navbar navbar-expand-md navbar-dark default">
      <div class="container">
        <a class="navbar-brand bg-transparent" href="#">
          <img src="<?php echo e(asset($logo .'logo-dark.png')); ?>" alt="logo" />
        </a>
        <button
        ...
        <div class="row align-items-center justify-content-center mb-5  mobile-screen">
          <div class="col-auto">
            <div class="wow animate__fadeInRight mobile-widget" data-wow-delay="0.2s">
              ...
              <img
                src="<?php echo e(asset($logo.$company_logo)); ?>"
                alt=""
                class="img-fluid"
              />
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-sm-12">
            <img src="<?php echo e(asset('$logo.$company_logo')); ?>" alt="logo" />
          </div>
  ...
  </style><?php /**PATH D:\wamp64\www\saas\resources\views/layouts/landing.blade.php ENDPATH**/ ?>